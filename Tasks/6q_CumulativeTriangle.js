...
// Starting with the number "1", "1" is positioned at the top of the triangle. As this is the 1st row,
// it can only support a single number.
...
function cumulativeTriangle(n) {
  return n != 1 ? n * cumulativeTriangle(n - 1) : 1;
}
console.log(cumulativeTriangle(5));
