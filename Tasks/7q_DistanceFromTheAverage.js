...
// rounding each difference to the second decimal digit (this is not needed in Haskell); extra points if you do so in some smart, clever or concise way :)
...
function distancesFromAverage(arr) {
  ...
  return arr.map((item) => +(-item + averageValue).toFixed(2));
}
