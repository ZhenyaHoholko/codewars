...
function dirReduc(arr) {
  ...
  while (i < arr.length - 1) {
    if (
      (arr[i].toUpperCase() === "NORTH" &&
        arr[i + 1].toUpperCase() === "SOUTH") ||
      (arr[i].toUpperCase() === "SOUTH" &&
        arr[i + 1].toUpperCase() === "NORTH") ||
      (arr[i].toUpperCase() === "EAST" &&
        arr[i + 1].toUpperCase() === "WEST") ||
      (arr[i].toUpperCase() === "WEST" && arr[i + 1].toUpperCase() === "EAST")
    ) {
      arr.splice(i, 2);
      i = 0;
    } else {
